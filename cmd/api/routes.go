...
func (app *application) routes() http.Handler {
	...
	mux.Del("/api/v1/user/:uuid/ingredient/:ingredientID", app.jwtVerification(NewPermissionsCheck(http.HandlerFunc(app.deleteUserIngredientAssociation), []string{"user:write", "self:write"})))
